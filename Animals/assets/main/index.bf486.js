window.__require = function e(t, n, r) {
  ...
  AnimalCube: [ function(require, module, exports) {
    ...
    var AnimalCube = function(_super) {
      ...
      AnimalCube.prototype.remove = function(index, cb) {
        var _this = this;
        this.scheduleOnce(function() {
          cb && cb(_this.animType);
  ...
  DataManager: [ function(require, module, exports) {
    ...
    var DataManager = function() {
      ...
      DataManager.prototype.getCanUseTool = function(id) {
        return this.getToolDataById(id).countNumber > 0;
      };
  ...
  Enum: [ function(require, module, exports) {
    ...
    (function(GAME_POOL) {
      ...
      GAME_POOL["UI_ANIM_FLY"] = "UI_ANIM_FLY";
  ...
  GameData: [ function(require, module, exports) {
    ...
    exports.ToolDataLocal = [ [ 1, "+\u5206\u6570", "\u5c06\u603b\u5206\u63d0\u9ad810%", 200 ], [ 4, "+\u65f6\u95f4", "\u4ee5+5\u79d2\u5f00\u59cb\u6e38\u620f", 200 ], [ 5, "5-4", "\u5168\u5c40\u53ea\u67094\u79cd\u52a8\u7269", 800 ] ];
    exports.useFirstData = false;
    exports.InitDiamondCount = 0;
  ...
  Game: [ function(require, module, exports) {
    ...
    var ShowVideoUI_1 = require("./UI/ShowVideoUI");
    var TimeOutUI_1 = require("./UI/TimeOutUI");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var Game = function(_super) {
      ...
      function Game() {
        ...
        _this.flyAnimPrefab = null;
        _this.flyScoreRoot = null;
        _this.canUseTip = null;
        _this.cdLabel = null;
        _this.cdTimeTip = null;
        _this.levelAnimal = [];
      ...
      Game.prototype.update = function(dt) {
        ...
        var lastTime = Math.ceil(this.gameMaxTime - this.gameTime);
        var showCD = lastTime > 0 ? lastTime + "" : "1";
        if (this.cdLabel.string != showCD) {
          if (lastTime <= 5 && lastTime >= 1) {
            this.cdTimeTip.node.active = true;
            this.cdTimeTip.node.opacity = 0;
            this.cdTimeTip.setSprite("pic/time/" + lastTime);
            this.cdTimeTip.node.stopAllActions();
            cc.tween(this.cdTimeTip.node).to(.2, {
              opacity: 255
            }).delay(.5).to(.3, {
              opacity: 0
            }).start();
          } else this.cdTimeTip.node.active = false;
          this.cdLabel.string = showCD;
        }
        if (timeprogress <= 1) {
      ...
      Game.prototype.initData = function() {
        ...
        if (DataManager_1.default.instance.currentUseToolID == Enum_1.TOOL_TYPE.TIME) {
          var useToolData = DataManager_1.default.instance.getToolDataById(DataManager_1.default.instance.currentUseToolID);
          if (DataManager_1.default.instance.getCanUseTool(useToolData.id)) {
            useToolData.countNumber--;
            this.gameMaxTime += 5;
          }
        }
        ...
        var animalCount = 5;
        if (DataManager_1.default.instance.currentUseToolID == Enum_1.TOOL_TYPE.FIVETOFOUR) {
          var useToolData = DataManager_1.default.instance.getToolDataById(DataManager_1.default.instance.currentUseToolID);
          if (DataManager_1.default.instance.getCanUseTool(useToolData.id)) {
            useToolData.countNumber--;
            animalCount = 4;
        ...
        if (DataManager_1.default.instance.currentDeleteAnimal >= useAnimalData.skillNeedCube) {
          ...
          switch (Number(useAnimalData.id)) {
           case Enum_1.ANIMAL_TYPE.Bear:
            this.gameMaxTime = this.gameMaxTime + 3;
            break;

           case Enum_1.ANIMAL_TYPE.Kitty:
            this.gameMaxTime = this.gameMaxTime + 5;
            break;

           case Enum_1.ANIMAL_TYPE.Frog:
            this.gameMaxTime = this.gameMaxTime + 8;
            break;

           case 4:
            this.gameMaxTime = this.gameMaxTime + 10;
            break;

           case 5:
            this.gameMaxTime = this.gameMaxTime + 12;
            break;

           case 6:
            this.gameMaxTime = this.gameMaxTime + 15;
            break;

           case 7:
            this.gameMaxTime = this.gameMaxTime + 20;
            break;
           ...
           case 9:
            this.gameMaxTime = this.gameMaxTime + 30;
            break;
      ...
      Game.prototype.eliminateSelection = function() {
        ...
        var _loop_1 = function(i) {
          ...
          var startPos = node.parent.convertToWorldSpaceAR(node.position);
          node.getComponent(AnimalCube_1.default).remove(i, function(id) {
            _this.flyAnimal(startPos, id, function() {});
          });
      ...
      Game.prototype.flyAnimal = function(startPos, id, endCB) {
        var animal = PoolManager_1.default.instance.getNode(this.flyAnimPrefab, this.flyScoreRoot, Enum_1.GAME_POOL.UI_ANIM_FLY);
        animal.getComponent(cc.Sprite).setSprite(Enum_1.ANIMAL_TYPE_TEXTUREURL[id]);
        animal.setPosition(this.flyScoreRoot.convertToNodeSpaceAR(startPos));
        animal.scale = .8;
        var end = this.energyProgressInBtn.node.parent.convertToWorldSpaceAR(this.energyProgressInBtn.node.position);
        var endPos = this.flyScoreRoot.convertToNodeSpaceAR(end);
        cc.tween(animal).to(.4, {
          position: endPos
        }, {
          easing: "quadOut"
        }).call(function() {
          PoolManager_1.default.instance.putNode(animal, Enum_1.GAME_POOL.UI_ANIM_FLY);
          endCB && endCB();
        }).start();
      };
      ...
      Game.prototype.showVideoUI = function() {
        var _this = this;
        if (0 == this.showVideoTime) {
          this.showVideoTime++;
          ResManager_1.default.instance.loadRes(Enum_1.GAME_Prefab.showVideoUI.url).then(function(prefab) {
            if (cc.isValid(prefab)) {
              var node = cc.instantiate(prefab);
              node.parent = _this.node;
              node.zIndex = Enum_1.GAME_Prefab.showVideoUI.zIndex;
              node.getComponent(ShowVideoUI_1.default).init(function(isOk) {
                if (isOk) {
                  _this.gameMaxTime += 10;
                  _this.isGaming = true;
                } else _this.showTimeOut();
              });
            }
          });
        } else this.showTimeOut();
      };
      Game.prototype.showTimeOut = function() {
        var _this = this;
        ResManager_1.default.instance.loadRes(Enum_1.GAME_Prefab.timeOutUI.url).then(function(prefab) {
          if (cc.isValid(prefab)) {
            var node = cc.instantiate(prefab);
            node.parent = _this.node;
            node.zIndex = Enum_1.GAME_Prefab.timeOutUI.zIndex;
            node.getComponent(TimeOutUI_1.default).init(_this.onShowAnimLevel.bind(_this));
          }
        });
      };
      ...
      __decorate([ property(cc.Prefab) ], Game.prototype, "flyAnimPrefab", void 0);
      ...
      __decorate([ property(cc.Label) ], Game.prototype, "cdLabel", void 0);
      __decorate([ property(cc.Sprite) ], Game.prototype, "cdTimeTip", void 0);
    ...
    "./UI/ShowVideoUI": "ShowVideoUI",
    "./UI/TimeOutUI": "TimeOutUI"
  } ],
    ...
    var LevelShowUI = function(_super) {
      ...
      LevelShowUI.prototype.initUI = function(data) {
        ...
        data.forEach(function(value, key) {
          ...
          DataManager_1.default.instance.getAnimalDataById(key).score += value;
  ...
  Main: [ function(require, module, exports) {
    ...
    var Main = function(_super) {
      ...
      Main.prototype.reloadRes = function() {
        ...
        cc.resources.preloadDir("pic", function(err) {
          if (err) {
            cc.error("\u52a0\u8f7d\u5931\u8d25:", err);
            return;
          }
        ...
        cc.resources.preloadDir("prefab", function(err) {
          if (err) {
            cc.error("\u52a0\u8f7d\u5931\u8d25:", err);
            return;
          }
  ...
  ReadyUI: [ function(require, module, exports) {
    ...
    var ReadyUI = function(_super) {
      ...
      ReadyUI.prototype.initToolUI = function() {
        ...
        EventManager_1.default.instance.emit(Enum_1.ENUM_GAME_EVENT.READYUI_CHOOSE_TOOLITEM, DataManager_1.default.instance.currentUseToolID);
      };
  ...
  ScoreUI: [ function(require, module, exports) {
    ...
    var ScoreUI = function(_super) {
      ...
      ScoreUI.prototype.initUI = function() {
        ...
        var addBase = 0;
        if (DataManager_1.default.instance.currentUseToolID == Enum_1.TOOL_TYPE.SCORE) {
          var useToolData = DataManager_1.default.instance.getToolDataById(DataManager_1.default.instance.currentUseToolID);
          if (DataManager_1.default.instance.getCanUseTool(useToolData.id)) {
            useToolData.countNumber--;
            addBase = .1 * DataManager_1.default.instance.currentScore;
          }
        }
  ...
  ShowVideoUI: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2dc73latCdHJ5Q3xKrs4RoX", "ShowVideoUI");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var AudioManager_1 = require("../../Manager/AudioManager");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var ShowVideoUI = function(_super) {
      __extends(ShowVideoUI, _super);
      ...
      ShowVideoUI.prototype.onLoad = function() {};
      ShowVideoUI.prototype.init = function(cb) {
        this.isStart = true;
        this.cb = cb;
      };
      ShowVideoUI.prototype.update = function(dt) {
        if (!this.isStart) return;
        this.cdTime += dt;
        var timeprogress = this.cdTime / this.maxTime;
        if (timeprogress <= 1) {
          timeprogress = Math.floor(timeprogress *= 1e4);
          this.progress.fillRange != 1 - timeprogress / 1e4 && (this.progress.fillRange = 1 - timeprogress / 1e4);
        } else {
          this.isStart = false;
      ...
      ShowVideoUI.prototype.onBtnClose = function() {
        AudioManager_1.default.instance.playBtn();
        this.cb && this.cb(false);
        this.node.destroy();
      };
      ShowVideoUI.prototype.onBtnShowVideo = function() {
        this.cb && this.cb(true);
        this.node.destroy();
      };
      __decorate([ property(cc.Sprite) ], ShowVideoUI.prototype, "progress", void 0);
      ShowVideoUI = __decorate([ ccclass ], ShowVideoUI);
      return ShowVideoUI;
    }(cc.Component);
    exports.default = ShowVideoUI;
    cc._RF.pop();
  }, {
    "../../Manager/AudioManager": "AudioManager"
  } ],
  ...
  TimeOutUI: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "be93bqGV+xLTqiEAs9TVlLc", "TimeOutUI");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var TimeOutUI = function(_super) {
      __extends(TimeOutUI, _super);
      function TimeOutUI() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.time = null;
        _this.out = null;
      ...
      TimeOutUI.prototype.onLoad = function() {};
      TimeOutUI.prototype.init = function(endCB) {
        this.playTimeOut(endCB);
      };
      TimeOutUI.prototype.playTimeOut = function(endCB) {
        var _this = this;
        this.time.stopAllActions();
        this.out.stopAllActions();
        this.time.x = -550;
        this.out.x = 550;
        cc.tween(this.time).to(.2, {
          x: 0
        }).delay(1).to(.2, {
          x: -550
        }).start();
        cc.tween(this.out).to(.2, {
          x: 0
        }).delay(1).to(.2, {
          x: 550
        }).call(function() {
      ...
      __decorate([ property(cc.Node) ], TimeOutUI.prototype, "time", void 0);
      __decorate([ property(cc.Node) ], TimeOutUI.prototype, "out", void 0);
      TimeOutUI = __decorate([ ccclass ], TimeOutUI);
      return TimeOutUI;
    }(cc.Component);
    exports.default = TimeOutUI;
    cc._RF.pop();
  }, {} ],
...
}, {}, [ "SkeletonExt", "Enum", "GameData", "AnimalChoose", "AnimalCube", "AnimalManager", "DataManager", "Game", "GameUtils", "Main", "ToastManager", "GameSettingUI", "AnimalLevelItem", "ReadyAnimalItem", "ReadyToolItem", "LevelShowUI", "LoadSceneUI", "LoadUI", "MainBgUI", "ReadyUI", "ScoreUI", "SettingUI", "ShowVideoUI", "StartUI", "TimeOutUI", "AudioManager", "EventManager", "PoolManager", "ResManager" ]);